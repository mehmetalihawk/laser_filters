...
#define NODE_MAIN_LOGGER_NAME "scan_to_cloud_filter_chain"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liblaser_filter_chains.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ScanToCloudFilterChain>";
